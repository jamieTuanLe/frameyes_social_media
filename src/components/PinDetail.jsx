...
const PinDetail = ({ user }) => {
  ...
  return (
    <>
      <div className="flex xl:flex-row flex-col m-auto bg-white" style={{ maxWidth: '1500px', borderRadius: '32px' }} >
        ...
        <div className="flex-1 w-full p-5 xl:min-w-620">
          ...
          <div className="" >
            ...
            <p className="mt-3 ml-1">{pinDetail?.about}</p>
          </div>
          <Link to={`/user-profile/${pinDetail?.postedBy?._id}`} className="flex gap-2 mt-6 items-center">
            <img
          ...
          <h2 className="text-xl mt-5 font-bold">Comments...</h2>
          ...
          <div className="flex flex-wrap mt-6 gap 3 items-center">
            ...
            <button
              type="button"
              className="bg-red-500 px-4 py-2 rounded-3xl text-white font-bold ml-4 outline-none"
              onClick={addComment}
            >
      ...
      {pins ? (
        <>
          <h2 className="text-center font-bold text-3xl mt-8 mb-4">More like this</h2>
